...
using mattresses_management.Activation;
using mattresses_management.Core.Services;
using mattresses_management.Services;
using mattresses_management.Views;
...
namespace mattresses_management
{
    ...
    public sealed partial class App : PrismUnityApplication
    {
        ...
        protected override async Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "mattresses_management.ViewModels.{0}ViewModel, mattresses_management", viewType.Name.Substring(0, viewType.Name.Length - 4));
